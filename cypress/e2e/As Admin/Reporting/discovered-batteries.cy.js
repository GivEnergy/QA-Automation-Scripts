...
describe("reporting discovered batteries filter", () => {
    it("tests reporting discovered batteries filter", () => {
        ...
        cy.get('div[class*="v-list-item__content"]').contains('9.5kWh (186Ah)').click();
